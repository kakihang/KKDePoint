...
// 使用KVC修改为默认按钮，再修改渲染颜色 _kk
- (void)setNavTintColor:(UIColor *)color {
    if (self.leftBtn) {
        [self.leftBtn setValue:@(UIButtonTypeSystem) forKey:@"buttonType"];
        [self.leftBtn setTintColor:color];
    }
    if (self.rightBtn) {
        [self.rightBtn setValue:@(UIButtonTypeSystem) forKey:@"buttonType"];
        [self.rightBtn setTintColor:color];
    }
    if (self.backBtn) {
        [self.backBtn setValue:@(UIButtonTypeSystem) forKey:@"buttonType"];
        [self.backBtn setTintColor:color];
    }
}
